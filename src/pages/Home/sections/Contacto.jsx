function Contacto() {
  return (
    <section className="w-full bg-cyan-50">
      ...
      <div className="w-full md:h-112.5 flex flex-col-reverse sm:flex-row-reverse">
        {/* Mapa */}
        <iframe
          className="w-full sm:w-5/6 md:4/6 xl:w-5/6 h-96 sm:h-109.75 md:h-full"
            ...
            <p className="mb-2">
              <span>
                <svg
                  ...
                  viewBox="0 0 512 512"
                  className="w-4 h-4 mr-1 inline-block align-middle fill-cyan-950"
                >
