...
function MisCitasRegistroUser() {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            setError('Ocurrió un problema en el registro de usuario/a. Inténtalo de nuevo');
    ...
    return (
        ...
        <section className='w-full min-h-dvh py-10 px-5 relative flex flex-col justify-start items-center overflow-hidden bg-cyan-50'>
            ...
            <h1 className='py-10 relative text-cyan-800 text-center text-4xl font-bold'>Crea tu cuenta</h1>
            ...
            <form onSubmit={(e) => {
                ...
                <label htmlFor='apellido' className='font-medium text-cyan-800'>Apellido</label>
                <input type='text'
                    name='apellido'
                    id='apellido'
            ...
            {error && !loading && (
                <p className='relative mb-2 text-red-900 text-lg text-center font-bold'>{error}</p>
            )}
            ...
            {mensaje && (
                ...
                <div className='w-full lg:w-xl p-4 my-6 bg-green-100 relative flex flex-col gap-2 border border-green-700 text-green-800 rounded shadow-md'>
                    ...
                    <p><span className='font-bold underline underline-offset-2'><Link to='/mis-citas/login'>Inicia sesión</Link></span> para pedir cita o modificar tus datos</p>
                </div>
            )}
